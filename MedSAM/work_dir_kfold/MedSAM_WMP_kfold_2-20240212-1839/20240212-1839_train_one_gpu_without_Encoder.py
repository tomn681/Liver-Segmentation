...
class LiverDataset(Dataset):
    def __init__(self, data_root, transform = None, mode = 'Training',kfold=False, img_ext = '.png', msk_ext = '.png',num_classes = 1):
...
def main():
    ...
    lits_train_dataset = LiverDataset(args.data_path, transform = transform_train_lits, mode = 'Training',kfold=args.kfold)
    lits_val_dataset = LiverDataset(args.data_path, transform = transform_val_lits, mode = 'Test',kfold=args.kfold)
