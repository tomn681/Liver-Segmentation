...
def parse_args():    
    ...
    parser.add_argument('-val_freq',type=int,default=1,help='interval between each validation') ### Default 100 (evaluar cada 100 epochs)
    ...
    parser.add_argument('-dataset', default='lits' ,type=str,help='dataset name')
    ...
    '-data_path',
    type=str,
    default='../datasets/Lits/imgs_1ch/',
